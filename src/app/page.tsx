...
export default function Home() {
  ...
  <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col lg:flex-row">
    ...
    <div className="lg:w-1/2 w-full lg:pl-10 flex flex-col items-start text-left text-white">
      <h1 className="title-font  text-yellow-600 sm:text-4xl text-3xl mb-4  font-semibold font-serif bg-opacity-80 p-2 rounded-lg">
        Expertise in HTML, CSS, JavaScript, TypeScript
      </h1>

      {/* Typewriter Effect */}
      <h2 className="title-font font-extrabold bg-yellow-600 text-white p-2 mb-4 rounded-lg
      shadow-lg">
        <Typewriter
          options={{
      ...
      <p className="mb-8 leading-relaxed font-bold bg-yellow-600 bg-opacity-80 p-4 rounded-lg shadow-md">
    ...
    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font   text-yellow-600 font-medium">n6ra5-simple-calculator</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-white rounded flex p-4 h-full items-center">
          ...
          <span className="title-font text-yellow-600 font-medium">123fcli-number-guessing</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font  text-yellow-600 font-medium">n7ra7-atm-machine</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font text-yellow-600 font-medium">n2ra2-to-do-list-</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font  text-yellow-600 font-medium">nfk-currency-converter</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-100 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font  text-yellow-600 font-medium">nfk_word-counter</span>
        </div>
      </div>
    </div>
...
<footer className="text-white  from-gray-600 to-gray-500 body-font">
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p className=" text-white text-sm  sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4"> 2024 Noor Fatima
